...
public class Partido {
    ...
    private int votos_nominais_totais = 0;
    ...
    public int getVotos_nominais_totais() {
        return votos_nominais_totais;
    }

    public void add_Votos_nominais_totais(int incremento) {
        this.votos_nominais_totais += incremento;
    }
    ...
    public void add_Candidato(Candidato candidato) {
        //Atribui os votos recebidos pelo candidato aos votos totais do partido.
        add_Votos_nominais_totais(candidato.getVotos());
    ...
    public String toString() {
        ...
        return  "Partido: " + "nome_partido= " + nome_partido + ",\n" +
                ...
                space + "votos_nominais_totais= " + votos_nominais_totais + ",\n" +
                space + "Candidatos:\n" +
                "----------------------------------------\n" + candidatos + "\n\n";
    }
}